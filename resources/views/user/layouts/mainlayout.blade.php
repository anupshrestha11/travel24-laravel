   ...
   @if(!Request::is('/'))
    ...
    <footer class="main__footer">
        ...
        <div class="social">
            ...
            <ul>
                <li><a href="">
                        <svg viewBox="0 0 36 36" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4" fill="url(#jsc_s_2)" height="40" width="40">
                            <defs>
                ...
                <li><a href="">
                        <svg class="gUZ lZJ U9O kVc" height="36" width="36" viewBox="0 0 24 24" aria-hidden="true" aria-label="" role="img">
                ...
                <li>
                    <a href="">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Gmail_icon_%282020%29.svg/200px-Gmail_icon_%282020%29.svg.png" width="36px" alt="">


                    </a>
                </li>
                <li><a href="">
                        <img src="https://instagram.com/static/images/ico/favicon.ico/36b3ee2d91ed.ico" alt="">
